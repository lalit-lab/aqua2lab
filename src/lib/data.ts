...
export const galleryItems: GalleryItem[] = [
  {
    ...
    image: "https://images.unsplash.com/photo-1544551763-8a445585562e?w=1200&q=85&auto=format&fit=crop",
    description: "A lush, jungle-style planted aquarium with over 30 species of tropical plants cascading through driftwood.",
  },
  {
    title: "Zen Rock Garden",
    category: "Iwagumi",
    image: "https://images.unsplash.com/photo-1611915387288-fd8d2f5f928b?w=1200&q=85&auto=format&fit=crop",
    description: "Classic Iwagumi layout — Seiryu stones arranged in golden ratio with a dense Hemianthus carpet.",
  },
  {
    ...
    description: "A high-tech Dutch aquascape with terraced rows of stem plants in contrasting reds, greens and gold.",
  },
  {
    title: "Emerald Desktop",
    category: "Nano",
    image: "https://images.unsplash.com/photo-1520301255226-bf5f144451c1?w=1200&q=85&auto=format&fit=crop",
    description: "A 30 cm nano scape for a luxury home office — Anubias nana, mini Bolbitis and Moss on lava rock.",
  },
  {
    title: "The Driftwood Forest",
    category: "Nature Style",
    image: "https://images.unsplash.com/photo-1619984403099-90fe7f660d7f?w=1200&q=85&auto=format&fit=crop",
    description: "Spiderwood branches draped in Fissidens and Java Moss create a submerged rainforest canopy.",
  },
  {
    title: "Crystal Iwagumi",
    category: "Iwagumi",
    image: "https://images.unsplash.com/photo-1484291470158-b8f8d608850d?w=1200&q=85&auto=format&fit=crop",
    description: "Minimalist Ohko dragon stone layout with a flawless Eleocharis carpet — pure negative space.",
  },
  {
    title: "Moss & Stone Nano",
    category: "Nano",
    image: "https://images.unsplash.com/photo-1571752726703-5e7d1f6a986d?w=1200&q=85&auto=format&fit=crop",
    description: "A 25 cm cube scape featuring Christmas Moss, Weeping Moss and a single Manten stone.",
  },
];
